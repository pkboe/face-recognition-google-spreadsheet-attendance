...
recognizer = pickle.loads(
    open(
        "C:\\Users\\asus\Desktop\\face-recognition-using-deep-learning\\output\\recognizer",
        "rb").read())
le = pickle.loads(
    open(
        "C:\\Users\\asus\\Desktop\\face-recognition-using-deep-learning\\output\\le.pickle",
        "rb").read())

# initialize the video stream, then allow the camera sensor to warm up
print("Starting Video Stream...")
# convert video capture to video stream
vs = VideoStream(src=0).start()
# vs = cv2.VideoCapture('http://192.168.1.3:4747/mjpegfeed?640x480')
time.sleep(2.0)
